...
const ImportResources = () => {
  const discoveredResources = [
    { type: "EC2 Instance", name: "web-server-01", region: "us-east-1", status: "running" },
    { type: "RDS Database", name: "prod-db", region: "us-east-1", status: "available" },
    { type: "S3 Bucket", name: "assets-bucket", region: "us-east-1", status: "active" },
    { type: "Load Balancer", name: "main-alb", region: "us-east-1", status: "active" },
    { type: "Lambda Function", name: "api-handler", region: "us-east-1", status: "active" },
  ];
          ...
          <div className="container mx-auto p-8 space-y-8">
            ...
            <div className="flex items-center justify-between animate-fade-in">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Reverse engineer existing AWS infrastructure</p>
                </div>
              </div>
            </div>
            ...
            <Card className="glass-card border-border/50">
              <CardHeader>
                ...
                <CardDescription>
                  Provide your AWS credentials to discover and import existing resources
                </CardDescription>
              </CardHeader>
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>Resources found in your AWS account</CardDescription>
                  </div>
