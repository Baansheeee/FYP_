...
const Chatbot = () => {
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content: "Hello! I'm your AWS assistant. Describe your infrastructure needs and I'll help you design the perfect solution.",
    },
  ]);
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      setMessages(prev => [
        ...
        {
          role: "assistant",
          content: "I understand you need a scalable web application. I recommend using EC2 instances with an Application Load Balancer, RDS for database, and S3 for static assets. Would you like me to generate the architecture diagram?",
        },
      ]);
    }, 1000);
  };
            ...
            <div className="mb-6 animate-fade-in">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Describe your AWS needs in natural language</p>
                </div>
              </div>
            </div>
